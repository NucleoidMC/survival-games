...
public final class CachingBlender {
    ...
    public synchronized LinkedBiomeWeightMap blend(long seed, int chunkBaseWorldX, int chunkBaseWorldZ, ScatteredBiomeBlender.BiomeEvaluationCallback callback) {
